...
def get_weather():
    city = entry_city.get()
    api_key = "2fe62296096278d8f10a9b11f03a78a0"  # Replace with your actual API key
...
window.geometry("400x400")  # Adjust the dimensions as needed

# Apply a theme for a more modern look (using 'clam' theme here)
style = ttk.Style()
style.theme_use("clam")

# Configure a bold font for the result text
bold_font = Font(weight="bold")

# Configure the 'Green.TButton' style with green color
